...
public class Main implements MobileCapabilityTypeEx {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<String> androidDeviceList = Arrays.asList("R58N7200YDJ", "emulator-5554");
        ...
        //Hash map contains test scripts: key = devices ID (tring), value : list (class - test case sau khi chặt)
